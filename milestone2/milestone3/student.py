class Student:
    ...
    def __init__(self, student_id, name):
        ...
        self.name = name
        self.courses = {}
        self.courses_taken = set()  # set of course_id strings for prereq tracking

    def complete_course(self, course_id):
        """Mark a course as completed for prerequisite tracking."""
        self.courses_taken.add(course_id)

    def has_taken(self, course_id):
        """Return True if the student has completed this course."""
        return course_id in self.courses_taken
